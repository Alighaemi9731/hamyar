      ...
      >
        <div className="p-8 print:p-0">
          ...
          <footer className="mt-6 border-t pt-3 text-xs text-black/60">
            ارقام از خود فاکتورها خوانده می‌شود، نه از نرخ امروز روی جمع فروش: مالیات هر سطر
            هنگام نهایی شدن فاکتور محاسبه و ذخیره شده و همان عدد اینجا جمع می‌شود. فاکتورهای
            ابطال‌شده شمرده نمی‌شوند، هرچند شمارهٔ آن‌ها محفوظ می‌ماند.
          </footer>
        </div>
      </PrintLayout.A4>
    </AppShell>
