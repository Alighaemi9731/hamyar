    ...
    <AppShell title="راهنمای همتا">
      ...
      <div className="max-w-3xl space-y-8">
        ...
        <Section title="اگر انتقال انجام نشود چه می‌شود؟">
          <p>
            گوشی برای مدتی عادی کار می‌کند، اما در نهایت ممکن است روی شبکه محدود شود. آن موقع مشتری
            به فروشگاه شما برمی‌گردد — نه به فروشندهٔ قبلی. به همین دلیل ثبت انتقال، بیش از آنکه یک
            الزام اداری باشد، محافظ اعتبار فروشگاه است.
          </p>
          <p>
            نکتهٔ مهم: تا وقتی گوشی به نام فروشندهٔ قبلی است، از نظر سامانه آن شخص مالک است. برای
            همین قدم اول چک‌لیست، تأیید همین موضوع است.
          </p>
        </Section>
        ...
        <Section title="روش‌های انتقال">
          <ul className="list-inside list-disc space-y-2">
            ...
            <li>
              <strong>سایت</strong> <span dir="ltr">hamta.ntsw.ir</span>.
            </li>
          </ul>
          <p className="text-sm text-muted-foreground">
            هر سه روش یک کار را انجام می‌دهند. کد دستوری معمولاً سریع‌ترین است چون به اینترنت نیاز
            ندارد.
          </p>
        </Section>
        ...
        <Section title="پیامک تأیید">
          <p>
            بعد از ثبت درخواست، پیامکی از سامانهٔ همتا <strong>برای مشتری</strong> ارسال می‌شود — نه
            برای فروشگاه. داخل این پیامک یک <strong>شناسهٔ فعال‌سازی</strong>
            هست که باید در چک‌لیست ثبتش کنید.
          </p>
          <p>
            معمولاً چند دقیقه طول می‌کشد. اگر شلوغ باشد ممکن است تا چند ساعت هم برسد؛ در این حالت
            می‌توانید انتقال را «انجام شد» ثبت کنید و شناسه را بعداً وارد کنید.
          </p>
        </Section>

        <Section title="اگر مشتری نماند یا انتقال ممکن نشد">
          <p>
            فروش را متوقف نکنید. در چک‌لیست، همان مرحله را <strong>«انجام نشد»</strong> بزنید و
            دلیلش را بنویسید. دستگاه در فهرست{' '}
          ...
          <p className="text-sm text-muted-foreground">
            همین یادداشت است که اگر ماه‌ها بعد اختلافی پیش بیاید، نشان می‌دهد فروشگاه کارش را انجام
            داده و چه چیزی مانع شده.
          </p>
        </Section>
      </div>
    </AppShell>
