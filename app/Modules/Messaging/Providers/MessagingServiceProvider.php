    ...
    public function register(): void
    {
        ...
        */
        $this->app->afterResolving(MetricRegistry::class, static function (MetricRegistry $registry): void {
            $registry->register(
                new Metric('messaging.sms', 'پیامک', Window::Month, 'messaging', unitFa: 'پیامک', position: 80, landing: true),
                new Metric('messaging.campaigns', 'کمپین پیامکی', Window::Month, 'messaging', unitFa: 'کمپین', position: 81),
            );
        });
