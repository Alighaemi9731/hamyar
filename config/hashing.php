...
return [
    ...
    */
    ...
    // Argon2id is the project default (master plan §11). Tests override it to
    // bcrypt with 4 rounds via phpunit.xml, because Argon's memory cost makes a
    // suite that creates hundreds of users needlessly slow.
