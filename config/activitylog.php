...
return [
     ...
     */
    // Ours stamps tenant_id from the current context. spatie's own model writes a
    // null tenant, which the RLS policy on activity_log rejects outright — an audit
    // trail any shop could read would be worse than none.
    'activity_model' => App\Modules\Identity\Models\Activity::class,
