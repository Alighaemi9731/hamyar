...
type Availability =
  { state: 'idle' } | { state: 'checking' } | { state: 'ok' } | { state: 'taken'; reason: string };
...
export default function Register({ domain }: Props) {
  ...
  return (
    <AuthLayout
      title="۱۴ روز رایگان شروع کنید"
      description="بدون کارت بانکی. در کمتر از یک دقیقه."
      width="lg"
      showTenant={false}
    >
      ...
      >
        ...
        <Field label="ایمیل (اختیاری)" error={form.errors.owner_email} htmlFor="owner_email">
          <Input
            id="owner_email"
            type="email"
            dir="ltr"
