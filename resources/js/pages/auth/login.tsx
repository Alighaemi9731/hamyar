...
export default function Login() {
  ...
  return (
    <AuthLayout
      title={tenant?.name ?? 'ورود به پنل فروشگاه'}
      description="برای ادامه، شماره موبایل و رمز عبور خود را وارد کنید."
      showTenant={false}
    >
      <Head title="ورود" />
      ...
      >
        <div className="space-y-1.5">
          ...
          />
          {form.errors.mobile && <p className="text-2xs text-destructive">{form.errors.mobile}</p>}
        </div>
