...
function MarkSection({ alt }: { alt?: boolean }) {
  return (
    <Section
      ...
      note="طرح سفارشی مالک، بازکشیده‌شده به مسیر برداری از روی همان تصویر. حرف‌ها بریدگی و شکاف خودشان را دارند: گوشهٔ بریدهٔ H و M، میله‌های آزاد زیر دو A، و شکاف افقی در R. رنگ از currentColor می‌آید، پس یک فایل روی سفید، روی سرمه‌ای و در نوار بالا کار می‌کند."
    >
